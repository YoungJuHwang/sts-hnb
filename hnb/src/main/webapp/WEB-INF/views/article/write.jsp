...
<TABLE WIDTH=620 HEIGHT=50 BORDER=0 CELLSPACING=1 CELLPADDING=1 ALIGN=CENTER>
	...
	<TR ALIGN=CENTER>
		<TD WIDTH=110 ALIGN=LEFT>
			<IMG SRC="${images}/btn_list.gif" id="go_list" onClick="javascript:location.replace('BoardList.jsp')" STYLE=CURSOR:HAND>
		</TD>
		<TD WIDTH=400 ALIGN=CENTER>		
			<IMG SRC="${images}/btn_save.gif" id="save" STYLE=CURSOR:HAND>&nbsp;&nbsp;
