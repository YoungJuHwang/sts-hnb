...
<script type="text/javascript">
	...
	var LoginMember = {
			detail : function(url) {
				$.getJSON(url,
					function(data){
					var table = '<table id="tab_detail"><tr><td rowspan="9" id="td_profile"><img id="profile" src="${images}/'+data.profile+'" width="70%" height="80%"/></td>'
			...
			updateForm : function() {
				$.getJSON(context+'/member/detail/${user.id}',
					...
					var table = '<table id="tab_detail"><tr><td rowspan="9" id="td_profile"><img id="profile" name="profile" src="${images}/'+data.profile+'" width="70%" height="80%"/></td>'
