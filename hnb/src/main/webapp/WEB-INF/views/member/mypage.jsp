...
<script type="text/javascript">
	...
	var LoginMember = {
			detail : function(url) {
				$.getJSON(url,
					function(data){
					var table = '<table id="tab_detail"><tr><td rowspan="8" id="td_profile"><img id="profile" src="${images}/default.png" width="70%" height="80%"/></td>'
					+'<th id="item">항목</th><th>빈 칸</th></tr><tr><td>아이디</td><td>${user.id}</td></tr><tr><td>비밀번호</td><td>${user.password}'
					+'</td></tr><tr><td>이름</td><td>${user.name}</td></tr><tr><td>생일</td><td>${useri.gender}</td></tr><tr>'
